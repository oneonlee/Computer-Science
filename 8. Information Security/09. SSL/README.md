...
### 2) Make an empty visual studio project and create a c++ source file with the code in lect10-winsslcli.docx.
...
### 6) Do the steps in Section 3 and 4.

### 7) Make the sniffer sniff "host www.wooribank.com and port 443" which is the default ssl port. Use your web browser to connect to www.wooribank.com and let the sniffer analyze the packets. Analyze only client hello and server hello. (read: http://max.euston.net/d/tip_ssldump.html)
...
### 10) Read articles about“heartbleed” attack in the Internet and summarize. Find actual attack incidents. Which function in OpenSSL can cause the "heartbleed" attack? Analyze this function and explain why it can allow the "heartbleed" attack.
